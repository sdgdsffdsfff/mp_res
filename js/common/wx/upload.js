define("common/wx/upload.js", ["widget/upload.css", "biz_web/lib/webuploader.js", "common/wx/dialog.js", "common/wx/Tips.js", "tpl/uploader.html.js"],
function(e) {
    "use strict";
    function i(e) {
    ...
    h = function(e) {
        ...
        t.on("beforeFileQueued",
        function(i) {
            return Math.random() < .1 && u(13),
            e.canContinueUpload && !e.canContinueUpload() ? !1 : !(e.onSelect && e.onSelect(null, i.id, i) === !1);
        }),
        t.on("fileQueued",
        function(e) {
            var i = {
        ...
        function(i, n) {
            ...
            e.onProgress && e.onProgress(null, i.id, i, {
                percentage: n
            });
        }),
        t.on("uploadStart",
        ...
        function(n, t, o) {
            if (Math.random() < .1 && u(16), t && t.base_resp) {
                ...
                case -8:
				case 200018:
					alert("页面停留时间过久，请刷新页面后重试！");
					break;
				case -20:
				case 200020:
					alert("无法解释该图片，请使用另一图片或截图另存");
					break;
				case -13:
				case 200013:
					alert("上传文件过于频繁，请稍后再试");
					break;
				case -10:
				case 200010:
					alert("上传文件过大");
				...
				case -39:
				case 200039:
					alert("上传图片高度（像素）与宽度（像素）的乘积不能超过600万");
					break;
				default:
					alert("上传文件发送出错，请刷新页面后重试！");
				}
            }
        ...
        function(i) {
            ...
            p.fadeOut().html(""),
            g = {},
            0 == i.numOfInvalid && i.numOfSuccess > 0 && e.onAllComplete && e.onAllComplete(null, {
