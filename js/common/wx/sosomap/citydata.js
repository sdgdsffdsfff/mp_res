define("common/wx/sosomap/citydata.js", ["common/wx/Cgi.js", "cardticket/sosomap_province_data.js"],
function(a) {
    "use strict";
    function t(a, n, o) {
    ...
    function o(a, t, n, l) {
        return n.end === !0 ? void("function" == typeof l && l(null)) : a[t] ? (n = n.sub[a[t].index], void o(a, t + 1, n, l)) : n && n.sub && n.sub.length > 0 ? void("function" == typeof l && l(n.sub)) : void e(function() {
            var t = {
                sub: []
            };
            o(a, 0, t, l);
    ...
    function l(a) {
        function t(n, o) {
            if (n.cidx) {
                ...
                a[o][e].value = a[o][e].fullname,
                a[o][e].name = a[o][e].fullname,
                n.sub.push(a[o][e]),
        ...
        o = 0, e = a[0].length; e > o; o++) a[0][o].shortName = a[0][o].name || a[0][o].fullname,
        a[0][o].value = a[0][o].fullname,
        a[0][o].name = a[0][o].fullname,
        n.sub.push(a[0][o]),
        t(n.sub[n.sub.length - 1], 1);
        return n;
    }
    ...
    c = a("cardticket/sosomap_province_data.js"),
    r = {
        getNextData: o,
        getCurDataByName: n,
        getCurDataByIndex: t,
