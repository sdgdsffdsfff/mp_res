define("common/wx/sosomap/map.js", ["common/wx/sosomap/event.js", "common/wx/sosomap/searchService.js", "common/wx/Tips.js", "common/wx/sosomap/util.js"],
function(t) {
    "use strict";
    function o(t) {
    ...
    i = t("common/wx/sosomap/event.js"),
    n = t("common/wx/sosomap/searchService.js"),
    s = t("common/wx/Tips.js"),
    a = t("common/wx/sosomap/util.js");
    return o.prototype = new soso.maps.MVCObject,
    $.extend(o.prototype, i),
    o.prototype.initDom = function() {
        this.$mainDiv = this.container.find(".mainDiv"),
        this.$result = this.container.find(".resultPanel"),
    ...
    o.prototype.initServer = function() {
        ...
        this.cityService = new soso.maps.CityService({
            complete: function(o) {
                e.latlng = o.detail.latLng,
                t.map.setCenter(e.latlng),
                t.trigger("sosomap:searchLocalCity", o);
            },
            error: function() {
        ...
        this.geocoderService = new soso.maps.Geocoder({
            complete: function(o) {
                ...
                0)),
                t.trigger("sosomap:getaddrcomplete", o);
            },
            error: function() {
                s.err("仅支持中国（含港澳台地区）地址，请重新定位具体地址。"),
                t.map.panTo(e.latlng ? e.latlng: new soso.maps.LatLng(e.lat, e.lng));
            }
        }),
    ...
    o.prototype.bindEvent = function() {
        var t = this;
        this.searchService.on("search:complete",
        function(o) {
            var e = o.detail.pois[0];
            e && 4 == e.type && t.map && t.map.panTo(e.latLng),
            t.trigger("sosomap:searchcomplete", o);
        }).on("search:error",
        function(o) {
    ...
    o.prototype.callmap = function(t) {
        ...
        return "function" == typeof this.map[t] ? this.map[t].apply(t, o) : void 0;
    },
    ...
    o.prototype.search = function(t) {
        ...
        var o = this.opt;
        t.pageCapacity || (t.pageCapacity = o.pageCapacity),
        this.searchService.search(t.keyword, t);
    },
    o.prototype.notifyResize = function() {
        var t = this.container.width(),
        o = this.container.height();
        this.$mainDiv.height(o),
        this.$mainDiv.width(t);
    },
