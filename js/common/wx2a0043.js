...
function(e) {
    function t(e, t) {
        for (var o = 0; o < t.length; ++o) if (e.indexOf(t[o]) > -1) return ! 0;
        return ! 1;
    }
    ...
    function() {
        function e(e, t) { - 1 == t.indexOf("ueditor") && -1 == t.indexOf("media/appmsg_edit") && jQuery.ajax({
        ...
        wx.jslog = function(o, n, i) {
            i = i || 3,
            o = jQuery.extend(o, t);
            var a = [];
            n && jQuery.each(["message", "stack", "lineNumber"],
            function(e, t) {
                a.push(t + ":" + (n[t] || ""));
            }),
            o.e = a.join(";").replace(/\s/g, " ");
    ...
    setTimeout(function() {
        seajs.use("biz_web/lib/store.js",
        function(e) {
            var t = $("#logout");
            t.click(function() {
                function t() {
                ...
                e.remove("hasNotice"),
                e.remove("templateClassStatus"),
                e.remove("templateClassStatusTime");
                var o = "__draft__" + wx.data.uin,
                n = "__draft__time__" + wx.data.uin;
    ...
    wx.injectXss = function(e, t, o) {
        ...
        if (null != e) {
            t || (t = []),
            o || (o = "'\"<script>console.log(%s);</script><!--# &");
            for (var i in e) {
                var a = e[i];
                "string" == typeof a ? n(i) || (e[i] = o.sprintf(i) + a) : "object" == typeof a && wx.injectXss(e[i]);
            }
        }
    },
    jQuery(function() {
        ...
        function(e) {
            ...
            function() {
                if (!e.get("__zoom_tips__")) {
                    ...
                    n = 1;
                    try {
                        o = document.getElementById("ZoomFlash").getFlashStageRect().height,
                        n = ~window.navigator.userAgent.toLowerCase().indexOf("msie") && screen.deviceXDPI && screen.logicalXDPI ? screen.deviceXDPI / screen.logicalXDPI: o / t,
                        .9 > n ? (jQuery("#zoom_msg").text("您的浏览器目前处于缩小状态，会导致公众平台网页显示不正常，您可以键盘按“ctrl+数字0”组合键恢复初始状态。"), jQuery("#zoom_tips").show(), jQuery("body").addClass("scaled")) : n > 1.1 ? (jQuery("#zoom_msg").text("您的浏览器目前处于放大状态，会导致公众平台网页显示不正常，您可以键盘按“ctrl+数字0”组合键恢复初始状态。"), jQuery("#zoom_tips").show(), jQuery("body").addClass("scaled")) : (jQuery("#zoom_tips").hide(), jQuery("body").removeClass("scaled"));
                    } catch(i) {}
                }
            });
        }),
        jQuery(window).on("keyup",
        function(e) {
            e.ctrlKey && (96 == e.keyCode || 48 == e.keyCode) && (jQuery("#zoom_tips").hide(), jQuery("body").removeClass("scaled"));
        }),
        jQuery("#zoom_prompt").on("click",
        function() {
            seajs.use("biz_web/lib/store.js",
            function(e) {
                e.set("__zoom_tips__", !0);
            }),
            jQuery("#zoom_tips").hide(),
    ...
    seajs.use("common/wx/Log");
    var o = ["biz_common/utils/monitor.js", "biz_common/utils/huatuo.js"];
    seajs.on("request",
    function(e) {
        if (0 != location.host.indexOf("dev") && !/[a-f0-9]{6}\.(js|css)$/.test(e.requestUri) && !t(e.requestUri, o)) {
            var e = {
                res: e.requestUri,
                page: location.pathname + "?" + location.search
            },
            n = encodeURIComponent("res[{res}]; page[{page}]".format(e)); (new Image).src = wx.url("/misc/jslog?content=" + n + "&id=59&level=error");
        }
    });
} (window);;
$.fn.extend({
    center: function(i) {
        i ? (this.css("position", "fixed"), this.css("top", ($(window).height() - this.height()) / 2 + "px"), this.css("left", ($(window).width() - this.width()) / 2 + "px")) : (this.css("position", "absolute"), this.css("top", ($(window).height() - this.height()) / 2 + $(window).scrollTop() + "px"), this.css("left", ($(window).width() - this.width()) / 2 + $(window).scrollLeft() + "px"));
    }
});;
$.fn.disable = function(t) {
    ...
    this.parent().hasClass("btn_input") ? this.parent().addClass(t) : this.addClass(t),
    this;
},
$.fn.enable = function(t) {
    t = t || "btn_disabled";
    var s = this.hasClass("btn_input") ? this.find("button") : this;
    return s.attr("disabled", !1),
    this.parent().hasClass("btn_input") ? this.parent().removeClass(t) : this.removeClass(t),
    this;
},
function() {
    var t = function(t, s) {
...
$.fn.scrollLoading = function(o) {
    ...
    function c() {
        ...
        function(c, n) {
            var s = t($(n.obj));
            s && (n.src && "img" == n.tag.toLowerCase() && (n.obj.src = n.src, n.obj.data_src = n.src = ""), $.isFunction(o.callback) ? o.callback.apply(n.obj) : "");
        });
    }
    var n = {
        callback: $.noop,
    ...
    c(),
    o.context.unbind("scroll", c),
    o.context.bind("scroll", c);
},
$.fn.fixed = function() {
    var o = this,
    t = o.offset().top;
...
define("common/qq/jquery.plugin/serializeObject.js", [],
function() {
    "use strict";
});; !
function() {
...
function() {
    ...
    function r(t, n) {
        ...
        this.length > t ? this.slice(0, t - n.length) + n: String(this);
    }
    function e(t) {
    ...
    function i(t) {
        ...
        t === !1 && n.reverse();
        for (var r = 0,
        e = this; r < n.length; r += 2) e = e.replace(new RegExp(n[r], "g"), n[1 + r]);
        return e;
    }
    function o(t) {
    ...
    function h() {
        for (var t, n = this,
        r = 0,
        e = 0; t = n.charAt(r++);) e += t.charCodeAt().toString(16).length / 2;
        return e;
    }
    function l(t, n) {
        if ("function" == typeof this.split) {
            ...
            return r.each(function(n) {
                arr = n.split("="),
                2 == arr.length && arr[0] && arr[1] && (t === !0 ? e[decodeURIComponent(arr[0])] = decodeURIComponent(arr[1]) : e[arr[0]] = arr[1]);
            }),
            e;
        }
    }
...
function() {
    ...
    function e(t, n) {
        var r = this;
        return args = a.call(arguments, 2),
        t = 1e3 * t,
...
function() {
    function t(t, n) {
        for (var r = 0,
        e = this.length >>> 0; e > r; r++) r in this && t.call(n, this[r], r, this);
    }
    function n() {
...
function(t, n) {
    ...
    n.create = function(t) {
        ...
        return t.apply(n.prototype, arguments),
        n;
    },
    function() {
        function t(t) {
            for (var n = 1,
            r = arguments.length; r > n; n++) for (var e in arguments[n]) Object.prototype.hasOwnProperty.call(arguments[n], e) && (t[e] = arguments[n][e]);
            return t;
        }
        function r() {
        ...
        function e(t) {
            var n = i.call(this, t);
            return n.prototype.parent = this,
            n;
        }
        function i(n) {
            ...
            return t(o.prototype, i.prototype || {},
            n),
            o.__base__ = i.__base__ || o.prototype,
            o.GetStaticInstance = r,
            o.Inherit = o.inherit = e,
            o;
        }
        n.declare = i;
    } ();
...
define("common/wx/Tips.js", [],
function(e, r) {
    "use strict";
    function n(e, r, n) {
        $(".JS_TIPS").remove(),
        s = $(template.compile('<div class="JS_TIPS page_tips {type}" id="wxTips_' + (new Date).getTime() + '"><div class="inner">{=msg}</div></div>')({
            type: e || "error",
            msg: r
        })).appendTo("body").fadeIn(),
        t.delay(n || l.delay, null, s);
    }
    function t(e) {
    ...
    function c(e) {
        ...
        var r = "";
        return 0 == e.length ? "": (r = e.replace(/&/g, "&gt;"), r = r.replace(/</g, "&lt;"), r = r.replace(/>/g, "&gt;"), r = r.replace(/ /g, "&nbsp;"), r = r.replace(/\'/g, "&#39;"), r = r.replace(/\"/g, "&quot;"), r = r.replace(/\n/g, "<br>"));
    }
    var s, i = r,
    l = {
        errMsg: "系统发生错误，请稍后重试",
...
define("common/wx/dialog.js", ["biz_common/jquery.ui/jquery.ui.draggable.js", "tpl/dialog.html.js"],
function(t, e) {
    "use strict";
    function i(t) {
        var e = this;
        ...
        t = $.extend(!0, {},
        o, t),
        e.id = t.id = [s.uiName, "_", ++s.uid].join(""),
        t.icon = s.iconClass[t.type || "warn"];
        var i = [];
        i = t.msg.split("|"),
        t.msg = i[0] ? i[1] ? {
            title: i[0],
        ...
        function() {
            ...
            function(i, o) {
                t.buttons[i].click && $(o).click(function() {
                    return t.buttons[i].click.apply(e),
                    !1;
                });
            }),
...
define("common/wx/popup.js", ["common/wx/widgetBridge.js", "biz_common/jquery.ui/jquery.ui.draggable.js", "tpl/popup.html.js"],
function(t) {
    "use strict";
    ...
    $.widgetBridge("popup", {
        ...
        _create: function() {
            ...
            i.buttons && !$.isArray(i.buttons) && (i.buttons = [i.buttons]),
            !i.buttons.length && i.onOK && (i.buttons = [{
                text: "确定",
                type: "primary",
                click: function() {
                    var t = i.onOK && i.onOK.call(this); ! t && e();
                }
            },
            {
                text: "取消",
                click: function() {
                    var t = i.onCancel && i.onCancel.call(this); ! t && e();
                }
            }]),
            $.each(i.buttons,
            function(t, i) {
            ...
            var l;
            if (this.element.is("script[type=text/html]")) l = this.element.html(),
            ...
            if (i.content = l, this.$dialogWrp = $(o(i)).appendTo("body"), this.$dialogWrp.find(".dialog_bd").children(":first").show(), i.autoShow || this.$dialogWrp.hide(), this.$dialogWrp.find(".pop_closed").click(i.onClose || e), this.$dialogWrp.find(".js_btn").each(function(o) {
