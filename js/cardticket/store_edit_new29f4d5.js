...
function(e) {
    ...
    function t() {
        ...
        if (!e.sosomap_poi_uid) {
            var t = M.area;
            e.province = t[0] && t[0].data && t[0].data.fullname || "",
            e.city = t[1] && t[1].data && t[1].data.fullname || "",
            e.district = t[2] && t[2].data && t[2].data.fullname || "";
        }
        var a = !1;
        if (l.isTerritory(e.province) && (e.district = e.city, e.city = e.province, e.province = "", a = !0), !a && !e.district && 3 == M.area.length) return u.err("请选择省市区再提交"),
        !1;
        if (a && !e.district) return u.err("请选择省市区再提交"),
        !1;
        if (!e.city || !e.latitude || !e.longitude) return u.err("请选择地址或定位"),
        !1;
    ...
    function a() {}
    function i() {
        var e = parseFloat($("#js_latitude").val()),
        t = parseFloat($("#js_longitude").val());
    ...
    function s() {
        this.marker_drag_tpl = e("tpl/cardticket/marker_drag.html.js"),
        this.init();
    }
    function o(e) {
        var t = R;
        t.map.setCenter(new soso.maps.LatLng(e.lat, e.lng)),
        t.map.getZoom() < 10 && t.map.zoomTo(10);
    }
    function n(e) {
        if (M) {
            var t = e.detail;
    ...
    var c = (e("common/wx/sosomap/city_select.js"), e("common/wx/sosomap/map.js")),
    l = e("common/wx/sosomap/util.js"),
    p = wx.cgiData,
    d = e("tpl/cardticket/marker_show_new.html.js"),
    m = e("cardticket/store_marker.js"),
    ...
    w = p.data.wx_poi_uid && 4 == p.data.audit_state,
    g = p.data;
    e("common/wx/stopMultiRequest.js"),
    e("cardticket/common_template_helper.js");
    var k = e("cardticket/store_category.js"),
    y = [];
    ...
    if (w) {
        ...
        $("#js_branch_name").val(g.branch_name),
        $("#js_wx_poi_uid").val(g.wx_poi_uid),
        $("#searchSubmit").val(g.address);
    ...
    var S = e("cardticket/store_helper.js"),
    T = $("#js_store_build");
    S.initCreateForm(T,
    function() {}),
    T.submit(function() {
        ...
        if (T.valid()) {
            ...
            function(t) {
                if (0 == t.base_resp.ret) {
                    var a = w ? "编辑": "创建";
                    u.suc(e.sosomap_poi_uid ? "新门店" + a + "成功": "新门店" + a + "成功并提交审核"),
    ...
    $("#js_preview").click(function() {
        if (T.valid()) {
            ...
            if (!e) return ! 1;
            var a = !1,
            i = h.get("STORE_previewusername"),
            r = $(template.compile(O)({
                ...
                onOK: function() {
                    ...
                    function(e) {
                        if (0 == e.base_resp.ret) u.suc("发送预览成功，本预览链接将在12小时后失效，请及时查看"),
                        h.set("STORE_previewusername", s),
                        r.popup("hide");
    ...
    var z = e("cardticket/simple_search_map.js"),
    D = [];
    try {
        w || (D = j.parse(h.get(b)));
    } catch(E) {
    ...
    var V = new soso.maps.MarkerImage(p.iconpath.pin_big, new soso.maps.Size(26, 26), new soso.maps.Point(0, 72)),
    P = new z({
        ...
        submitcheck: function() {
            var e = this.getData();
            $("#js_province").val(e.province),
            $("#js_city").val(e.city),
            $("#js_district").val(e.district),
            $("#js_latitude").val(e.latitude),
            $("#js_longitude").val(e.longitude);
            var t, a = e.branch_name,
            r = /^(.+?)\((.+?)\)$/;
            return r.test(a) ? (t = RegExp.$1, a = RegExp.$2) : (t = a, a = ""),
            $("#js_business_name").val(t).prop("readonly", !0).addClass("disabled"),
            $("#js_branch_name").val(a).prop("readonly", !0).addClass("disabled"),
            $("#searchSubmit").val(e.street).prop("readonly", !0).addClass("disabled"),
            $("#js_sosomap_poi_uid").val(e.sosomap_poi_uid),
            e.telephone && $("#js_telephone").val(e.telephone),
            e.imported = !0,
            P.imported = !0,
            u.suc("导入门店信息成功"),
            this.closeWindow(),
            ...
            $("#js_remark").show(),
            P.clear(),
            M.update(e.province, e.city, e.district),
            M.disabled(),
            i(),
            !1;
        },
    ...
    $("#js_remark").click(function() {
        return $("#js_business_name").prop("readonly", !1).removeClass("disabled"),
        $("#js_branch_name").prop("readonly", !1).removeClass("disabled"),
        $("#searchSubmit").prop("readonly", !1).addClass("disabled"),
        $("#js_latitude").val(""),
        $("#js_longitude").val(""),
        $("#js_sosomap_poi_uid").val(""),
        $(this).hide(),
        $("#js_search_pos").show(),
        P.imported = !1,
        M.enable(),
    ...
    s.prototype = {
        init: function() {
            ...
            t = new m({
                ...
                submitcheck: function() {
                    var t = this.getData();
                    return $("#js_latitude").val(t.latitude),
                    $("#js_longitude").val(t.longitude),
                    P.clear(),
                    i(),
                    e.hide(),
                    !1;
        ...
        show: function() {
            ...
            e.openWindow(),
            e.marker.setDraggable(!0),
            r();
            for (var t = M.area,
            a = "",
            i = 0; i < t.length; i++) t[i] && (a += t[i].data.fullname);
    ...
    var L = new s;
    $("#js_mark_position").delegate("#js_open_mark", "click",
    function() {
        return P.searching && (P.cancel_search = !0),
        P.clear(),
        a(!0),
        L && L.show(),
        $("#js_remark").click(),
    ...
    var M = P.citySelect;
    M.on("city:changed", o),
    w && M.on("city:datainit",
    function() {
        M.update(g.province, g.city, g.district);
    }),
    R.on("sosomap:getaddrcomplete",
    function(e) {
        n(e);
    }),
