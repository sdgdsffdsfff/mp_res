define("biz_web/lib/store.js", ["biz_web/lib/json.js"],
function(e, t, n) {
    try {
        var r = +(new Date),
        ...
        s.getAll = function() {
            ...
            s.set = d(function(e, t, n) {
                return t = m(t),
                n === undefined ? s.remove(t) : (e.setAttribute(t, s.serialize(n)), e.save(u), n);
            }),
            ...
            s.clear = d(function(e) {
                ...
                e.load(u);
                for (var n = 0,
                r; r = t[n]; n++) e.removeAttribute(r.name);
                e.save(u);
            }),
